...
function Header() {
    ...
    return (
        <div className="py-5">
            <header className="flex h-[78px] justify-between w-full sm:flex sm:bg-regal-green sm:items-center sm:w-full sm:fixed sm:mt-0 sm:h-20 sm:top-0 sm:right-0 sm:left-0 z-10">
                ...
                <div className="hidden sm:block mr-6">
                    {toggleNavbar === 'menu' ? (
                        <>
                            <FontAwesomeIcon
                                icon={faBars}
                                className="text-2xl text-regal-yellow"
                                onClick={handleMenu}
                            />
                        </>
                    ) : (
                ...
                <section
                    ref={navbarRef}
                    onClick={handleClose}
                    className="sm:hidden flex items-center justify-end sm:absolute sm:top-20 sm:flex sm:flex-col sm:bg-regal-green-500 sm:w-full"
                >
                    <Menu />
                </section>
            </header>
