        ...
        <div className="grid bg-regal-green px-36 text-white">
            <header className="grid grid-cols-2 mt-10">
                ...
                <div className="flex text-base font-semibold justify-end items-center">
                    <a href="/" className=" w-24 h-12 p-3 text-center align-middle text-regal-yellow">
                        Home
                    </a>
                    <button className=" w-24 h-12 p-3">Login</button>
                    <button className=" p-3 bg-regal-yellow text-black w-32 h-12 rounded-md ml-3">Sign up</button>
                </div>
            </header>
            ...
            <div className="grid flex mt-36">
                <div className="grid grid-cols-2 flex">
                    <div className="items-center">
                        ...
                        <h4 className="text-sm mt-8 font-thin leading-loose">
                            Browse from our list of specials to place your order and have food delivered to you in no
                            time. Affordable, tasty and fast!
                        </h4>
                ...
                <div className="mb-36 grid grid-cols-2 gap-10">
                    ...
                    <div className="flex justify-end">
                        ...
                        />
                        <button className="min-w-0 max-h-12 bg-regal-yellow p-3 rounded-md text-black font-semibold">
                            Get notified
                        </button>
                    </div>
                </div>
